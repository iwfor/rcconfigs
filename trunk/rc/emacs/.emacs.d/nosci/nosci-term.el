...
(defun nosci-term-mode-hook ()
  ...
  (define-key term-raw-escape-map "\C-j" 'nosci-term-toggle-mode)
  (define-key term-mode-map "\C-x\C-j" 'nosci-term-toggle-mode)
  ...
  (define-key term-raw-map "\C-y" 'nosci-term-yank)
...
(add-hook 'term-mode-hook 'nosci-term-mode-hook)

;; Settings for all comint based modes
(defun nosci-comint-mode-hook()
  (setq comint-process-echoes t)
  (ansi-color-for-comint-mode-on))

(add-hook 'comint-mode-hook 'nosci-comint-mode-hook)
