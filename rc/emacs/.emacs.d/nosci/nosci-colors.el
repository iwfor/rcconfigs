...
(defun color-theme-nosci ()
  ...
  (custom-set-faces
   ...
   '(nosci-org-next-face ((t (:background "#4f97e9" :foreground "white" :box (:line-width 1 :style released-button)))))
   '(nosci-org-pending-face ((t (:background "#d85b00" :foreground "white" :box (:line-width 1 :style released-button)))))
   '(nosci-org-reading-face ((t (:background "#68527a" :foreground "white" :box (:line-width 1 :style released-button)))))
   ...
   ;; Non-Standard Faces
   '(nosci-fixme-face ((t (:background "#670000" :foreground "#ffffff" :bold t :box (:line-width 1 :color "#ff8e43")))))
   
   ;; Remaining Junk
   '(completion-dynamic-face ((t (:inherit 'match))))
   '(highlight ((t (:inherit 'match))))))

(defun color-theme-nosci-gui ()
  (color-theme-nosci)
  (custom-set-faces
   '(default ((t (:background "#191919" :foreground "#FFFFFF"))))))

(defun color-theme-nosci-terminal ()
  (color-theme-nosci)
  (custom-set-faces
...
;; Create some faces
(copy-face 'font-lock-warning-face 'nosci-fixme-face)
(make-face 'nosci-org-next-face)
(make-face 'nosci-org-pending-face)
(make-face 'nosci-org-reading-face)
(setq nosci-fixme-face       'nosci-fixme-face
      nosci-org-next-face    'nosci-org-next-face
      nosci-org-pending-face 'nosci-org-pending-face
      nosci-org-reading-face 'nosci-org-reading-face)

 ;; Load color-theme
(if terminal-frame (color-theme-nosci-terminal)
  (color-theme-nosci-gui))
